...
const PITCH_STAGES: PitchStage[] = [
  ...
  },
  {
    ...
    startSec: 300,
    endSec: 345,
    action: 'Integrated Data Quality & Conflict Audits',
    tabKey: 'extraction',
    whatToSay: '“When two geological reports disagree — like 10.20 MT vs 11.70 MT on Page 61 — we do not pick a winner arbitrarily. We raise a clear validation warning requiring human-geologist signoff directly in the Document Reader.”',
    proTip: 'Demonstrate the "Audited Conflicts" view and the "Mark as Verified by Geologist" button.',
  },
  {
    timeRange: '5:45 – 7:00',
    startSec: 345,
